...
\begin{figure}[H]
\includegraphics[width=0.9\linewidth]{../results/plots/different_timesteps_Eulers method.pdf}\caption{This is a plot of the earth's orbit for 100 years using Euler's method, with different timesteps.}\label{fig:timesteps-euler}
\end{figure}		
