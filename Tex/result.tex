...
\begin{figure}[H]
\includegraphics[width=1.1\linewidth]{../results/plots/innerplanets_verletAll.pdf}\caption{This is a plot of planets closest to the sun in the Solar System after 30 years of motion.}\label{fig:solarsystem_innerplanets}
\end{figure}
